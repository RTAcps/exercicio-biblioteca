    ...
    public partial class TabelasIniciais : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_itens_emprestimos", x => x.CodigoItem);
                    table.ForeignKey(
                        name: "FK_itens_emprestimos_livros_CodigoLivro",
                        column: x => x.CodigoLivro,
                        principalTable: "livros",
                        principalColumn: "Codigo",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_itens_emprestimos_emprestimos_NumeroEmprestimo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_itens_emprestimos_CodigoLivro",
                table: "itens_emprestimos",
                column: "CodigoLivro");

            migrationBuilder.CreateIndex(
                name: "IX_itens_emprestimos_NumeroEmprestimo",
                table: "itens_emprestimos",
